...
class TestStochastic:
    ...
    def test_dp_predicate_var(self):
        ...
        dp_res, acc_res = dv.dp_query_test(d1_query, d2_query, plot=False, repeat_count=500, get_exact=False)
    ...
    def test_powerset_sum(self):
        ...
        dp_res, acc_res = dv.dp_powerset_test(query_str, repeat_count=500, plot=False)
