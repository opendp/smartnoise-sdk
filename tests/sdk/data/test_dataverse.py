...
@pytest.mark.parametrize("dataverse_endpoint", [
        {"uri": "https://dataverse.harvard.edu/api/access/datafile/:persistentId?persistentId=doi:10.7910/DVN/E9QKIZ/TRLS9U&token=100"},
    ])
