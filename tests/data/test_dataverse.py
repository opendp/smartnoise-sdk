...
@pytest.mark.parametrize("dataverse_details", [
        ...
        {"host":
         "https://dataverse.harvard.edu/api/access/datafile/:persistentId?persistentId=doi:10.7910/DVN/E9QKIZ/TRLS9U", "token": os.environ.get("BURDOCK_DATAVERSE_TEST_TOKEN"),}
    ])
