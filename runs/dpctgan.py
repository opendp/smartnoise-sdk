...
import ctgan
from ctgan import DataTransformer
from ctgan import ConditionalGenerator 
from ctgan import Discriminator, Generator
from ctgan import Sampler 
...
class DPCTGANSynthesizer(SDGYMBaseSynthesizer, CTGANSynthesizer):
    ...
    def fit(self, data, categorical_columns=tuple(), ordinal_columns=tuple()):
        ...
        return self.loss_d_list, self.loss_g_list, self.alpha_list
