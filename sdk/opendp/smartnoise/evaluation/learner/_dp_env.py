...
class DPEnv(gym.Env):
    ...
    def __init__(self, LearnerParams, PrivacyParams, EvaluatorParams, DatasetParams, querypool, available_actions):
        ...
        self.episode = 0
        self.reward = 0      
        self.d1_dataset, self.d2_dataset, self.d1_metadata, self.d2_metadata = generate_neighbors(self.df, self.metadata)
    ...
    def _compute_reward(self, query):
        ...
        d1_dataset, d2_dataset, d1_metadata, d2_metadata = generate_neighbors(self.df, self.metadata)
