...
class Gaussian(AdditiveNoiseMechanism):
    def __init__(self, eps, delta=1.0E-16, sensitivity=1.0, max_contrib=1, confidence_widths=[0.95], n_rows=None):
        super().__init__(eps, delta, sensitivity, max_contrib, confidence_widths, n_rows)
