...
class WassersteinRandomizationMetric(MultiTableMetric):
    """
    ...
    def _compute(self, real_data, synthetic_data, metadata=None, iters=10, downsample_size=100):
        return self.wasserstein_randomization(real_data, synthetic_data, iters=10, downsample_size=100)
