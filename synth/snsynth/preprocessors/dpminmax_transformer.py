...
class DPMinMaxTransformer(BaseTransformer):
    ...
    def fit(self, raw_data, discrete_columns=tuple(), continuous_columns_lower_upper={}):
        ...
        for column_name in raw_data.columns:
            ...
            if column_name in discrete_columns:
                ...
                print (column_name)
                column_transform_info = self._fit_continuous(column_name, raw_column_data, self.epsilon/number_of_con_col, continuous_columns_lower_upper[column_name][0], continuous_columns_lower_upper[column_name][1])
